...
def test_ft_exercise(exercise_file_name, exercise_number):
    ...
    try:
        ...
        import sys
        sys.path.append(f"./ex{exercise_number}")
...
def main():
    ...
    if choice == "0":
        test_ft_exercise("ft_hello_garden", int(choice))
    elif choice == "1":
        test_ft_exercise("ft_garden_name", int(choice))
    elif choice == "2":
        test_ft_exercise("ft_plot_area", int(choice))
    elif choice == "3":
        test_ft_exercise("ft_harvest_total", int(choice))
    elif choice == "4":
        test_ft_exercise("ft_plant_age", int(choice))
    elif choice == "5":
        test_ft_exercise("ft_water_reminder", int(choice))
    elif choice == "6":
        test_ft_exercise("ft_count_harvest_iterative", int(choice))
        test_ft_exercise("ft_count_harvest_recursive", int(choice))
    elif choice == "7":
        test_ft_exercise("ft_seed_inventory", int(choice))
    elif choice == "a":
        # Test all exercises one by one
        test_ft_exercise("ft_hello_garden", 0)
        test_ft_exercise("ft_garden_name", 1)
        test_ft_exercise("ft_plot_area", 2)
        test_ft_exercise("ft_harvest_total", 3)
        test_ft_exercise("ft_plant_age", 4)
        test_ft_exercise("ft_water_reminder", 5)
        test_ft_exercise("ft_count_harvest_iterative", 6)
        test_ft_exercise("ft_count_harvest_recursive", 6)
        test_ft_exercise("ft_seed_inventory", 7)
    else:
